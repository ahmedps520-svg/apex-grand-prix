...
- **Tests:** the helicopter sees the player in the open and on the deck but not under it; at four stars it is up and, out of every unit's sight, the pursuit goes on with the escape bar at zero.
