...
- **Honest limits:** a getaway's difficulty is the pursuit's (no extra units or a helicopter called in beyond the stars); the line can be crossed again straight after an escape; the time is not shown on the race card, only as a notice.
