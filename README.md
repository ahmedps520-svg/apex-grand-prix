...
- **Safety car:** a car stopped on the track brings it out ahead of the leader; the field bunches up behind it at its speed with no overtaking, then it peels into the pits and the race goes green.
- **Graphics presets:** Low to Ultra, with realistic asphalt, the racing line rubbered in, skid marks from sliding tyres, screen-space ray-traced reflections on the wet road and the paint, soft shadows and SMAA.
