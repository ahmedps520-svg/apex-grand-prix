...
- **Tyre wear:** an option on the race setup and the championship: the tread goes with the sliding done and the grip with it, for you and the AI alike, with a tread panel on the speedo and the engineer's word when they are going off.
